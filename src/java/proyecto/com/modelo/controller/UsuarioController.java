...
public class UsuarioController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (opcion) {
            case 1 -> out.println(g.toJson(dao.listarPerso()));
            case 2 -> out.println(dao.crearPersona(new Usuario(0, request.getParameter("nombres"), request.getParameter("apellidos"), request.getParameter("usuario"), request.getParameter("clave"), "A")));
